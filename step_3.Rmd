...
```{bash eval=FALSE}
$VSEARCH --derep_fulllength $DIR/quality_check/chimera_removal/all_combined_q$Q\_unique_sort_denovo_ref.good --relabel "U_" --output $DIR/quality_check/chimera_removal/relabeled_denovo_ref.good 
```
